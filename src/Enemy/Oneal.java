...
public class Oneal extends Enemy {
    ...
    public void draw(Graphics2D g2, GamePanel gp, SuperEnemy se) {
        ...
        if (worldX + gp.tileSize > gp.player.worldX - gp.player.screenX &&
            ...
            drawOneal(screenX, screenY, g2, gp, se);
        }
    }
     ...
     * render oneal.
     */
    public void drawOneal(int x, int y, Graphics2D g2, GamePanel gp, SuperEnemy se) {
        if (this.LR == "left") {
            g2.drawImage(se.image[1][1 + this.imgNum], x, y, gp.tileSize, gp.tileSize, null);
        } else {
            g2.drawImage(se.image[1][4 + this.imgNum], x, y, gp.tileSize, gp.tileSize, null);
        }
    }

    /**
     * cap nhat speed cua oneal.
     */
